...
This week's work forced me to separate two ideas that I had been treating as the same. Reducing dependencies is valuable. Designing software so those dependencies can be replaced is even more valuable. **The first is an implementation choice. The second is an architectural one.**
