...
Continuum already stores identities, notes, articles, drafts, profile metadata and media locally.
...
*Insert screenshot: Media Library showing "Used In (2)".*
...
*Insert screenshot: Expanded "Used In" panel.*
...
It isn't something that needs to be published.

It isn't something that requires a new NIP.
