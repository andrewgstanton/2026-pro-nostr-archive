...
Nostr remains an important supported identity system.
...
This project builds upon capabilities that already exist within Continuum.
...
The existing browser extension already demonstrates secure communication between the browser and a local Continuum workspace for Nostr authentication. Continuum Vault builds upon this foundation by extending the same architecture to support legacy web authentication while preserving local-first principles and user control.
...
>
> **Nostr is one of the identity systems it supports.**